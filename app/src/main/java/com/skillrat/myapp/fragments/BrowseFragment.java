...
public class BrowseFragment extends Fragment
{
    ...
    {
        View rootview =  inflater.inflate(R.layout.fragment_browse, null);
         ...
         * Calling JSON
         */
        Call<List<Browse>> call = api.getMyJSON();

        /**
         * Enqueue Callback will be call when get response...
         */
        call.enqueue(new Callback<List<Browse>>() {
            @Override
            public void onResponse(Call<List<Browse>> call, Response<List<Browse>> response) {
                //Dismiss Dialog
                pDialog.dismiss();
                ...
                if (response.isSuccessful()) {
                     ...
                     * Got Successfully
                     */
                    browseList = response.body();
                    Log.d("emplist","emp: "+ browseList);



                    eAdapter = new SessionsAdapter(getContext(), browseList);
            ...
            @Override
            public void onFailure(Call<List<Browse>> call, Throwable t) {
